...
class CoWebsiteManager {
    ...
    private getDevicePixelRatio(): number {
        //on chrome, movementX and movementY return global screens coordinates while other browser return pixels
        //so on chrome we need to adjust using 'devicePixelRatio'
        return window.navigator.userAgent.includes('Chrome') ? window.devicePixelRatio : 1;
    }
